            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
				...
				<?php
					...
					{
						?>
							<li><a href="#about">Welcome <?php echo $userRow['username']; ?></a></li>
							<li><a href="logout.php">Logout</a></li>
						<?php		
					}
				?>
                
                <li class="dropdown"><a class="btn btn-lg btn-primary" href="#" role="button">Become a Chef</a></li>
              </ul>
            </div>
          </div>
        </nav>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img class="first-slide" src="img/food.jpg" alt="First slide">
          <div class="container">
        ...
        <div class="item">
          <img class="third-slide" src="img/food1.jpg" alt="Third slide">
          <div class="container">
            <div class="carousel-caption">
        ...
        <div class="container">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-4">
                    ...
                    <h4 class="service-heading"></h4>
                    <p class="text-muted">We cover your events and ceremonies for best price.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal1" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/portfolio/port1.jpg" class="img-responsive" alt="">
                    </a>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal2" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/portfolio/port2.jpg" class="img-responsive" alt="">
                    </a>
                    <div class="portfolio-caption">
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal5" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/portfolio/port5.jpg" class="img-responsive" alt="">
                    </a>
                    <div class="portfolio-caption">
                        <h4>Escape</h4>
                        <p class="text-muted">Website Design</p>
